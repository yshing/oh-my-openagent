...
function detectProvidersFromOmoConfig(): {
  ...
  try {
    ...
    return { hasOpenAI, hasOpencodeZen, hasZaiCodingPlan, hasKimiForCoding, hasOpencodeGo, hasVercelAiGateway, hasMinimax }
  } catch {
    return {
      hasOpenAI: true,
      hasOpencodeZen: true,
...
export function detectCurrentConfig(): DetectedConfig {
  ...
  const { hasOpenAI, hasOpencodeZen, hasZaiCodingPlan, hasKimiForCoding, hasOpencodeGo, hasVercelAiGateway, hasMinimax } = detectProvidersFromOmoConfig()
